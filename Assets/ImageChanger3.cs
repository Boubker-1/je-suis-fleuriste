...
public class ImageChanger3 : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (Composante1.currentScene == 7) SpriteNumber = Composante1.n2;
        if (Composante1.currentScene == 8) SpriteNumber = Composante1.n5;
        if (Composante1.currentScene == 9) SpriteNumber = Composante1.n8;
