...
public class ImageChanger1 : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (Composante1.currentScene == 7) SpriteNumber = Composante1.n0;
        if (Composante1.currentScene == 8) SpriteNumber = Composante1.n3;
        if (Composante1.currentScene == 9) SpriteNumber = Composante1.n6;
